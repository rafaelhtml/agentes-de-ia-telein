              ...
              <div className="bg-gradient-feature rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="bg-telein-orange text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold">1</div>
                    <div>
                      <h4 className="font-semibold text-foreground">Informe seu Produto</h4>
                      <p className="text-sm text-muted-foreground">Descreva o que você vende e para quem</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="bg-telein-orange text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold">2</div>
                    <div>
                      <h4 className="font-semibold text-foreground">IA Gera Ideias</h4>
                      <p className="text-sm text-muted-foreground">Nossa IA cria múltiplas abordagens personalizadas</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="bg-telein-orange text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold">3</div>
                    <div>
                      <h4 className="font-semibold text-foreground">Use e Converta</h4>
